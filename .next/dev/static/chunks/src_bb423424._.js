...
function ClinicPage({ itemId, categoryId }) {
    ...
    const [partnerCategories, setPartnerCategories] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const isPartnerCategoryRoute = categoryId === 'partners' && itemId !== 'partners' && isNaN(Number(itemId));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClinicPage.useEffect": ()=>{
            const shouldLoadPartnerCategories = itemId === 'partners' || categoryId === 'partners' || currentRoute.includes('/clinic/partners');
            ...
            fetch('/api/partners').then({
                ...
                "ClinicPage.useEffect": (data)=>{
                    ...
                    setPartnerCategories(Array.from(grouped.values()).sort({
                        "ClinicPage.useEffect": (a, b)=>a.name.localeCompare(b.name, 'ru')
                    }["ClinicPage.useEffect"]));
                }
            }["ClinicPage.useEffect"]).catch({
                "ClinicPage.useEffect": ()=>setPartnerCategories([])
            }["ClinicPage.useEffect"]);
        }
    }["ClinicPage.useEffect"], [
        itemId,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                            ...
                                            children: selectedPartnerCategory?.name || 'Партнёры'
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/SMClinic/SMClinicPage.tsx",
                                            lineNumber: 282,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Партнёры выбранной категории"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/SMClinic/SMClinicPage.tsx",
                                            lineNumber: 285,
                                            columnNumber: 15
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    category.count,
                                                    " ",
                                                    category.count === 1 ? 'партнёр' : category.count < 5 ? 'партнёра' : 'партнёров'
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/src/components/SMClinic/SMClinicPage.tsx",
                                                lineNumber: 896,
...
_s(ClinicPage, "v5nAChPTce9Vv30B39SgPwdRm/c=", false, function() {
    return [
        ...
        "NavigableClinicMenu.useEffect": ()=>{
            async function loadDynamicCategories() {
                try {
                    ...
                    const partnerChildren = Array.from(groupedPartners.entries()).map({
                        "NavigableClinicMenu.useEffect.loadDynamicCategories.partnerChildren": ([slug, name])=>({
                                id: slug,
                                title: name
                            })
                    }["NavigableClinicMenu.useEffect.loadDynamicCategories.partnerChildren"]).sort({
                        "NavigableClinicMenu.useEffect.loadDynamicCategories.partnerChildren": (a, b)=>a.title.localeCompare(b.title, 'ru')
                    }["NavigableClinicMenu.useEffect.loadDynamicCategories.partnerChildren"]);
                    // Обновляем menuData, добавляя категории в "questions" и "partners"
                    const updatedMenu = menuData.map({
                        "NavigableClinicMenu.useEffect.loadDynamicCategories.updatedMenu": (item)=>{
                            if (item.id === 'questions') {
                                return {
                                    ...item,
                                    children: questionCategories.map({
                                        "NavigableClinicMenu.useEffect.loadDynamicCategories.updatedMenu": (cat)=>({
                                                id: cat.slug,
                                                title: cat.name
                                            })
                                    }["NavigableClinicMenu.useEffect.loadDynamicCategories.updatedMenu"])
                                };
                            }
                            if (item.id === 'partners') {
                                return {
