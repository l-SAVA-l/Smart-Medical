...
"[project]/src/app/api/admin/appointments/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].appointment.findUnique({
            where: {
                id: appointmentId
            }
        });
        ...
        if (body.status !== undefined) {
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$appointments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["APPOINTMENT_STATUSES"].includes(body.status)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (body.admin_comment !== undefined) {
            updateData.admin_comment = typeof body.admin_comment === "string" && body.admin_comment.trim() ? body.admin_comment.trim() : null;
        }
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].appointment.update({
            where: {
                id: appointmentId
            },
            data: updateData,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e88939d2._.js.map