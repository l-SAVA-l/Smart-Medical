...
async function POST(request) {
    try {
        ...
        if (!specialistId || !scheduledAt) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Укажите врача и дату/время"
            }, {
                status: 400
            });
        }
        ...
        if (serviceId != null && serviceId !== "") {
            const s = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].service.findFirst({
                where: {
        ...
        if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].appointment?.create !== "function") {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19959f22._.js.map