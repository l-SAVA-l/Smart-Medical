...
"[project]/src/app/api/admin/appointments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const where = {};
        if (status !== "all" && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$appointments$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["APPOINTMENT_STATUSES"].includes(status)) {
            where.status = status;
        }
        if (search) {
            where.OR = [
        ...
        const totalCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].appointment.count({
            where
        });
        ...
        const statusCounts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].appointment.groupBy({
            by: [
                "status"
            ],
            _count: {
        ...
        const countsByStatus = Object.fromEntries(statusCounts.map((s)=>[
                s.status,
                s._count.status
            ]));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4ae9933b._.js.map